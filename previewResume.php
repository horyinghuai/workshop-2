            ...
            <div id="formatted-container" class="report-col w-full lg:w-1/2 p-6 h-full overflow-y-auto">
                ...
                <form id="aiForm" class="space-y-1">
                    ...
                    <div class="mt-8 pt-6 flex gap-4">
                        ...
                        <button type="button" 
                                onclick="if(confirm('Are you sure you want to cancel? This candidate will be removed.')) location.href='previewResume.php?action=delete&candidate_id=<?php echo $candidate_id; ?>&email=<?php echo urlencode($email); ?>'" 
