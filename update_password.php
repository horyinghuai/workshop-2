...
// 2. Database Connection (Ensure 'connection.php' is correct)
...
// 4. Update the password in the database using prepared statements for security
...
if ($stmt->execute()) {
    if ($stmt->affected_rows > 0) {
        ...
        // Email not found (or password was already the same)
        http_response_code(404);
        echo "Error: The email address provided was not found or the password was not changed.";
    }
} else {
    // Database error
